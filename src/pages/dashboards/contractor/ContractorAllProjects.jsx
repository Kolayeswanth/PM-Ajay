...
const ContractorAllProjects = ({ contractorName }) => {
    ...
    // Fetch all projects for this executing agency from backend
    useEffect(() => {
        if (contractorName) {
    ...
    const handleExportData = () => {
        ...
        link.setAttribute('download', `Contractor_Projects_${new Date().toISOString().split('T')[0]}.csv`);
