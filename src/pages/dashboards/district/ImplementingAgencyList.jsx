...
const ImplementingAgencyList = ({ stateName }) => {
    const { user } = useAuth();
        ...
        <div className="dashboard-panel" style={{ padding: 20 }}>
            <div className="dashboard-section">
                <div className="section-header">
                    <h2 className="section-title">Implementing Agencies - {stateName || 'Loading...'}</h2>
                </div>
                                ...
                                {agencies.length > 0 ? (
                                    ...
                                    <tr>
                                        <td colSpan="6" style={{ textAlign: 'center', padding: '40px', color: 'var(--text-tertiary)' }}>
                                            No implementing agencies found for {stateName}.
                                        </td>
                                    </tr>
                                )}
                            </tbody>
